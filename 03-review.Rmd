...
bal.tab(school_nearest, m.threshold = 0.1)
nearest_matched <- match.data(school_nearest)
## model 0 - might inform treatment heterogeneity
summary(lm(`% Chronically Absent` ~ treatment, data = nearest_matched))
## model 1 - might inform treatment heterogeneity
summary(lm(`% Chronically Absent` ~ treatment*PercentSWD+  borough, data = nearest_matched))
## model 2
summary(lm(`% Chronically Absent` ~ treatment +PercentSWD +
             PercentBlack + ENI + PercentPoverty, data = nearest_matched))
